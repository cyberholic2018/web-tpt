<template>
    <div class="row">
        <div class="col-md-12" v-if="isLoaded">
            <div v-if="supports.length === 0" class="alert alert-info" role="alert">
                目前沒有支援項目，趕快去新增一個吧!
            </div>
            <table v-else class="table field-table">
                ...
                <tbody>
                    <tr v-for="item in supports" >
                        ...
                        <td align="center"><span @click="editSupport(item)" class="glyphicon glyphicon-pencil" style="cursor: pointer"></span></td>
                    </tr>
                </tbody>
                <tfoot>
                    <tr>
