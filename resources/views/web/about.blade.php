...
@section('content')
  ...
  <section class="numbertwo">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-5 col-img"><img class="img-responsive" src="https://dummyimage.com/640x420/000/fff" alt=""/></div>
      ...
      <div class="row">
        <div class="col-md-12 col-bigimg"><img class="img-responsive" src="https://dummyimage.com/960x540/000/fff" alt=""/></div>
        <div class="row">
