...
Vue.component('item-list', __webpack_require__(294));
...
Component.options.__file = "D:\\Work Station\\Project\\server\\web-tpt_20180421\\resources\\assets\\js\\components\\admin\\support\\item-list\\item-list.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] item-list.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b4079716", Component.options)
  } else {
    hotAPI.reload("data-v-b4079716", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        this.getSupportData('/admin/support/get');
    },
    watch: {
        isAllSelected: {
    ...
    computed: {
        isAllSelected: function isAllSelected() {
            ...
            this.supports.forEach(function (item) {
                if (!item.isSelect) {
                    status = false;
                }
            });
        ...
        selectedSupports: function selectedSupports() {
            var selectedRows = [];
    ...
    methods: {
        ...
        doListFunction: function doListFunction() {
            var self = this;
            ...
            switch (this.listFunction) {
                case 'deleteSupport':
                    ...
                    break;
                default:
                    console.log(self.selectedSupports);
                    console.log(this.listFunction);
            }
        },
        editSupport: function editSupport(item) {
            window.location = '/cyberholic-system/support/edit/' + item.id;
        },
        deleteSupports: function deleteSupports() {
            var self = this;
            ...
            $.ajax({
                ...
                self.getSupportData('/admin/support/get');
            }).fail(function () {
        ...
        nextPage: function nextPage() {
            this.getSupportData(this.next_page_url);
        },
        prevPage: function prevPage() {
            this.getSupportData(this.prev_page_url);
        },
        gotoPage: function gotoPage(item) {
            this.getSupportData('/admin/support/get?page=' + item.pageNumber);
        },
        getSupportData: function getSupportData(url) {
            var self = this;

            var getSupports = new Promise(function (resolve, reject) {
                $.ajax({
                    url: url,
                    type: 'GET',
                    cache: false,
            ...
            Promise.all([getSupports]).then(function (results) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  })]), _vm._v(" "), _c('th', [_vm._v("檔案名稱")]), _vm._v(" "), _c('th', [_vm._v("類別")]), _vm._v(" "), _c('th', [_vm._v("語系")]), _vm._v(" "), _c('th', [_vm._v("建立時間")]), _vm._v(" "), _c('th', {
    staticStyle: {
      "text-align": "center"
    },
    attrs: {
  ...
  }, [_vm._v("編輯")])])]), _vm._v(" "), _c('tbody', _vm._l((_vm.supports), function(item) {
    return _c('tr', [_c('td', [_c('input', {
    ...
    })]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.fileName))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.type))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.locale))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.created_at))]), _vm._v(" "), _c('td', {
      attrs: {
        "align": "center"
      }
    }, [_c('span', {
      ...
      on: {
        "click": function($event) {
          _vm.editSupport(item)
        }
      }
    })])])
  })), _vm._v(" "), _c('tfoot', [_c('tr', [_c('td', [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.allSelect),
  ...
  }, [_c('table', [_c('tr', [_c('td', [_c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.listFunction),
    ...
    on: {
      "change": function($event) {
        ...
        _vm.listFunction = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
  }, [_c('option', {
    attrs: {
  ...
  }, [_vm._v("請選擇動作")]), _vm._v(" "), _c('option', {
    attrs: {
      "value": "deleteSupport"
    }
  }, [_vm._v("刪除")])])]), _vm._v(" "), _c('td', [_c('button', {
  ...
  }, [_vm._v("下一頁")])]) : _vm._e()], 2)]) : _vm._e()])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-b4079716", module.exports)
  }
}
