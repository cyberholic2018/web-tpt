...
Vue.component('product-list', __webpack_require__(224));
...
Component.options.__file = "D:\\Work Station\\Project\\server\\web-tpt_20180421\\resources\\assets\\js\\components\\admin\\product\\product-list\\product-list.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-085d0be3", Component.options)
  } else {
    hotAPI.reload("data-v-085d0be3", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        getProductData: function getProductData(url) {
            var self = this;
            var token = this.token;
            ...
            Promise.all([getProducts, getCategory]).then(function (results) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }), _vm._v(" "), _vm._m(0)])]), _vm._v(" "), (_vm.products.length === 0) ? _c('div', {
  ...
  }, [_vm._v("商品名稱")]), _vm._v(" "), _c('th', {
    on: {
      "click": function($event) {
        _vm.toggleOrder('author')
      }
    }
  }, [_vm._v("建立者")]), _vm._v(" "), _c('th', {
    on: {
      "click": function($event) {
  ...
  }, [_vm._v("建立時間")])])]), _vm._v(" "), _c('tbody', _vm._l((_vm.products), function(item) {
    ...
    }, [_vm._v(_vm._s(item.title))])]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.authorName))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.category))]), _vm._v(" "), _c('td', [(item.locale == 'en') ? _c('span', [_c('strong', [_vm._v("英文")])]) : _vm._e(), _vm._v(" "), (item.locale == 'zh-TW') ? _c('span', [_c('strong', [_vm._v("繁體中文")])]) : _vm._e()]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.created_at))])])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-085d0be3", module.exports)
  }
}
