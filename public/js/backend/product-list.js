...
Vue.component('product-list', __webpack_require__(227));
...
Component.options.__file = "resources\\assets\\js\\components\\admin\\product\\product-list\\product-list.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-43ff084a", Component.options)
  } else {
    hotAPI.reload("data-v-43ff084a", Component.options)
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-43ff084a", module.exports)
  }
}
