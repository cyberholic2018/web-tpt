...
Vue.component('bonus-setup', __webpack_require__(259));
...
Component.options.__file = "D:\\Work Station\\Project\\server\\web-tpt_20180421\\resources\\assets\\js\\components\\admin\\business\\bonus-setup\\bonus-setup.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] bonus-setup.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ca6a50c8", Component.options)
  } else {
    hotAPI.reload("data-v-ca6a50c8", Component.options)
  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_js_toggle_button__ = __webpack_require__(12);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getBonusParameter: function getBonusParameter() {
            var self = this;
            ...
            Promise.all([getParameter]).then(function (results) {
        ...
        addBonusParameter: function addBonusParameter() {
            var self = this;
            ...
            $.ajax({
                ...
                self.showMessage('success', '新增紅利點數設定成功');
            }).fail(function () {
                console.log("error");
            }).always(function () {
        ...
        updateBonusParameter: function updateBonusParameter() {
            var self = this;
            var token = this.token;
            ...
            $.ajax({
                ...
                self.showMessage('success', '編輯紅利點數設定成功');
            }).fail(function () {
                console.log("error");
            }).always(function () {
                self.getBonusParameter();
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.businessLogic.defaultPoint),
      expression: "businessLogic.defaultPoint"
    }],
    ...
    on: {
      "input": function($event) {
        ...
        _vm.businessLogic.defaultPoint = $event.target.value
      }
    }
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.businessLogic.percentage),
      expression: "businessLogic.percentage"
    }],
    staticClass: "form-control",
    attrs: {
      "type": "number"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.businessLogic.percentage = $event.target.value
      }
    }
  }), _vm._v(" "), _c('span', {
    staticClass: "input-group-addon"
  }, [_vm._v("%")])])])]), _vm._v(" "), _c('tr', [_vm._m(3), _vm._v(" "), _c('td', [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.businessLogic.recommendUserSharePoint),
      expression: "businessLogic.recommendUserSharePoint"
    }],
    staticClass: "form-control",
    attrs: {
      "type": "number"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.businessLogic.recommendUserSharePoint = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('tr', [_vm._m(4), _vm._v(" "), _c('td', [_c('toggle-button', {
    model: {
      value: (_vm.businessLogic.bonusUseLimitSetup),
      callback: function($$v) {
        _vm.businessLogic.bonusUseLimitSetup = $$v
      },
      expression: "businessLogic.bonusUseLimitSetup"
    }
  })], 1)]), _vm._v(" "), (_vm.businessLogic.bonusUseLimitSetup) ? _c('tr', [_vm._m(5), _vm._v(" "), _c('td', [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.businessLogic.maxUsage),
      expression: "businessLogic.maxUsage"
    }],
    staticClass: "form-control",
    attrs: {
      "type": "number"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.businessLogic.maxUsage = $event.target.value
      }
    }
  })])]) : _vm._e(), _vm._v(" "), (_vm.businessLogic.bonusUseLimitSetup) ? _c('tr', [_vm._m(6), _vm._v(" "), _c('td', [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.businessLogic.minUsage),
      expression: "businessLogic.minUsage"
    }],
    staticClass: "form-control",
    attrs: {
      "type": "number"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.businessLogic.minUsage = $event.target.value
      }
    }
  })])]) : _vm._e()])]), _vm._v(" "), (_vm.isSetuped) ? _c('div', {
    staticClass: "panel-footer"
  }, [(_vm.isDirty) ? _c('button', {
    ...
    on: {
      "click": function($event) {
        _vm.updateBonusParameter()
      }
    }
  }, [_vm._v("儲存參數")]) : _c('button', {
    staticClass: "btn btn-success btn-sm btn-block",
    attrs: {
      "type": "button",
      "name": "button",
    ...
    on: {
      "click": function($event) {
        _vm.addBonusParameter()
      }
    }
  }, [_vm._v("新增參數")]) : _c('button', {
    staticClass: "btn btn-success btn-sm btn-block",
    attrs: {
      "type": "button",
      "name": "button",
  ...
  return _c('td', [_c('label', [_vm._v("使用者預設起始點數")])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('td', [_c('label', [_vm._v("紅利點數使用比率")])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('td', [_c('label', [_vm._v("推薦者獎勵點數")])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('td', [_c('label', [_vm._v("開啟點數使用設定")])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('td', [_c('label', [_vm._v("最高可使用點數")])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('td', [_c('label', [_vm._v("最低可使用點數")])])
}]}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-ca6a50c8", module.exports)
  }
}
